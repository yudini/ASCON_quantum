...
# key,nonce,tag,:128, datablock: 64, pa:12, pb:8
...
def main(eng):
    ...
    Initialization(eng, pa, S[256:320], S[192:256], S[128:192], S[64:128], S[0:64], key, new_ancilla_x0, new_ancilla_x1,
                   new_ancilla_x2, new_ancilla_x3, new_ancilla_x4)  # end
    Associated(eng, pb, A, A_len, S[256:320], S[192:256], S[128:192], S[64:128], S[0:64], new_ancilla_x0,
               new_ancilla_x1, new_ancilla_x2, new_ancilla_x3, new_ancilla_x4)
    ...
    Finalization(eng, pa, S[256:320], S[192:256], S[128:192], S[64:128], S[0:64], key, new_ancilla_x0, new_ancilla_x1,
                 new_ancilla_x2, new_ancilla_x3, new_ancilla_x4)
